...
export default function ChatUserDialog({
  ...
  return (
    <Dialog open={open}>
      <DialogContent className="bg-neutral-500">
        <DialogHeader>
          <DialogTitle className="text-neutral-950">Add Name and Passcode</DialogTitle>
          <DialogDescription className="text-neutral-800">
            Add your name and passcode to join in room
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="mt-2 bg-gray-300 rounded-md">
            <Input
